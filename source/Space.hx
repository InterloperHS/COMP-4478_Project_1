...
add(cd);
var tween2:FlxTween = FlxTween.tween(cd, { x: 100, y: 250, height:cd.height+30, width:cd.width+30 }, 2);
var tween3:FlxTween = FlxTween.tween(ali, { x:100, y: 250, height:cd.height+30, width:cd.width+30 }, 2);
}
